...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__18643){
var vec__18644 = p__18643;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18644,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18644,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__18651_SHARP_){
return (((p1__18651_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__18651_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__18674,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__18674;
}
});
...
var G__18689 = (i__4532__auto___18687 + (1));
i__4532__auto___18687 = G__18689;
continue;
} else {
}
break;
...
var G__18682 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_(classes))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18682,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__18682;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq18681){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq18681));
});
...
var vec__18692 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__18699 = cljs.core.ffirst(matches);
var fexpr__18698 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__18698.cljs$core$IFn$_invoke$arity$1 ? fexpr__18698.cljs$core$IFn$_invoke$arity$1(G__18699) : fexpr__18698.call(null,G__18699));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18692,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18692,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some(((function (matches,vec__18692,tag_name,names){
return (function (p1__18690_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__18690_SHARP_))){
return p1__18690_SHARP_;
} else {
return null;
}
});})(matches,vec__18692,tag_name,names))
,names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1(((function (matches,vec__18692,tag_name,names){
return (function (p1__18691_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__18691_SHARP_));
});})(matches,vec__18692,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__18750){
...
var tag = first__18753;
var content = seq__18752__$1;
...
var vec__18761 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18761,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18761,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18761,(2),null);
...
//# sourceMappingURL=sablono.normalize.js-59a50205.map
