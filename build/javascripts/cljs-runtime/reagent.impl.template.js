...
var G__36037 = o;
(G__36037[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36043 = o;
(G__36043[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__36082__i = 0, G__36082__a = new Array(arguments.length -  0);
while (G__36082__i < G__36082__a.length) {G__36082__a[G__36082__i] = arguments[G__36082__i + 0]; ++G__36082__i;}
  args = new cljs.core.IndexedSeq(G__36082__a,0,null);
} 
return G__36081__delegate.call(this,args);};
G__36081.cljs$lang$maxFixedArity = 0;
G__36081.cljs$lang$applyTo = (function (arglist__36083){
...
var G__36046 = props;
var G__36046__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36046,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36046);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36046__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36049){
...
var props = map__36050__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36050__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__36050,map__36050__$1,props,class$){
return (function (c){
...
});})(map__36050,map__36050__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36053){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36054__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__36054,map__36054__$1,on_write){
return (function (){
...
});})(node_value,map__36054,map__36054__$1,on_write))
);
} else {
...
var G__36057 = jsprops;
(G__36057["defaultValue"] = value);

(G__36057["onChange"] = ((function (G__36057,v,value,on_change){
return (function (p1__36056_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36056_SHARP_);
});})(G__36057,v,value,on_change))
);
...
var vec__36059 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36059,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36059,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36059,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___36098 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36098 == null)){
} else {
var key_36099 = temp__5739__auto___36098;
(jsprops["key"] = key_36099);
}
...
var temp__5739__auto___36101 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36101 == null)){
} else {
var key_36102 = temp__5739__auto___36101;
reagent.impl.template.oset(jsprops,"key",key_36102);
}
...
var G__36063 = reagent.impl.template.__GT_NativeWrapper();
(G__36063["name"] = c);
...
var G__36064 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36064) : reagent.impl.template.as_element.call(null,G__36064));
} else {
...
var len__4730__auto___36129 = arguments.length;
var i__4731__auto___36130 = (0);
while(true){
if((i__4731__auto___36130 < len__4730__auto___36129)){
args__4736__auto__.push((arguments[i__4731__auto___36130]));

var G__36132 = (i__4731__auto___36130 + (1));
i__4731__auto___36130 = G__36132;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36067){
var G__36068 = cljs.core.first(seq36067);
var seq36067__$1 = cljs.core.next(seq36067);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36068,seq36067__$1);
});
...
var n__4607__auto___36145 = a.length;
var i_36146 = (0);
while(true){
if((i_36146 < n__4607__auto___36145)){
(a[i_36146] = reagent.impl.template.as_element((a[i_36146])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___36149 = a.length;
var i_36150 = (0);
while(true){
if((i_36150 < n__4607__auto___36149)){
var val_36151 = (a[i_36150]);
if(((cljs.core.vector_QMARK_(val_36151)) && ((reagent.impl.template.key_from_vec(val_36151) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36150] = reagent.impl.template.as_element(val_36151));

var G__36152 = (i_36150 + (1));
i_36150 = G__36152;
continue;
} else {
}
...
var ctx = ({});
var vec__36071 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36071,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36071,(1),null);
...
var G__36074 = (cljs.core.count(argv) - first_child);
switch (G__36074) {
case (0):
...
case (1):
var G__36075 = comp;
var G__36076 = jsprops;
var G__36077 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__36075,G__36076,G__36077);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__36074){
