...
if((i < len)){
var k = (ks[i]);
var G__36031 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36032 = (i + (1));
m = G__36031;
i = G__36032;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35922 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35922);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35924 = c;
var G__35924__$1 = (((G__35924 == null))?null:G__35924.prototype);
if((G__35924__$1 == null)){
return null;
} else {
return (G__35924__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35926 = c;
var G__35926__$1 = (((G__35926 == null))?null:G__35926.prototype);
if((G__35926__$1 == null)){
return null;
} else {
return (G__35926__$1["render"]);
}
})() == null)))));
});
...
var G__35934 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35934) : reagent.impl.component.as_element.call(null,G__35934));
};
...
var _STAR_current_component_STAR__orig_val__35935 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35936 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35936;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35935;
}});
...
return ((function (G__35943,G__35943__$1){
...
var c = this;
var G__35948_36045 = (c["cljsRatom"]);
if((G__35948_36045 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35948_36045);
}
...
var renders_36047 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36048 = cljs.core.first(cljs.core.vals(renders_36047));
if((cljs.core.count(renders_36047) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36047))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36048)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36048], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35949 = name;
switch (G__35949) {
case "":
...
var G__35972 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35972);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35981 = fiber;
var G__35981__$1 = (((G__35981 == null))?null:(G__35981["type"]));
if((G__35981__$1 == null)){
return null;
} else {
return (G__35981__$1["displayName"]);
}
})();
var parent = (function (){var G__35986 = fiber;
if((G__35986 == null)){
return null;
} else {
return (G__35986["return"]);
}
})();
var path = (function (){var G__35987 = parent;
var G__35987__$1 = (((G__35987 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35987) : reagent.impl.component.fiber_component_path.call(null,G__35987)));
if((G__35987__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35987__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__35989 = c;
if((G__35989 == null)){
return null;
} else {
return (G__35989["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35990._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__35992 = c;
if((G__35992 == null)){
return null;
} else {
return (G__35992["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__35994 = c;
if((G__35994 == null)){
return null;
} else {
return G__35994._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__35996 = instance;
if((G__35996 == null)){
return null;
} else {
return (G__35996["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__36001 = instance;
if((G__36001 == null)){
return null;
} else {
return G__36001._currentElement;
}
}
})();
var name = (function (){var G__36003 = elem;
var G__36003__$1 = (((G__36003 == null))?null:(G__36003["type"]));
if((G__36003__$1 == null)){
return null;
} else {
return (G__36003__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__36017 = elem;
if((G__36017 == null)){
return null;
} else {
return (G__36017["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__36022._owner;
}
}
})();
var path = (function (){var G__36023 = owner;
var G__36023__$1 = (((G__36023 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36023) : reagent.impl.component.component_path.call(null,G__36023)));
if((G__36023__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36023__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36026 = c;
var G__36026__$1 = (((G__36026 == null))?null:G__36026.constructor);
if((G__36026__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36026__$1);
}
}
})();
